...
public class OthersQuestionOne extends AppCompatActivity implements RewardedVideoAdListener {
        ...
        mBasicTwoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mRewardedVideoAd.isLoaded()){
                    ...
                    startActivity(new Intent(OthersQuestionOne.this,OthersQuestionTwo.class));
    ...
    public void onRewardedVideoAdClosed() {
        ...
        startActivity(new Intent(this,OthersQuestionTwo.class));
        loadRewardedVideoAd();
    }
